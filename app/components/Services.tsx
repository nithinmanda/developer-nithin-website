...
export default function Services() {
    return (
        <div id="services" className="relative overflow-hidden pt-8 pb-12 lg:pt-12 lg:pb-16 bg-background-light dark:bg-background-dark">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    {/* Service 1: Web Dev */}
                    <div className="group relative flex flex-col gap-5 rounded-2xl border border-gray-200 dark:border-border-dark bg-transparent p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary/50 hover:shadow-xl hover:shadow-primary/5">
