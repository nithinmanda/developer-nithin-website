    ...
    return (
        <section className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden project-card group">
            ...
            >
                ...
                <button
                    className={`group/btn flex items-center gap-4 px-8 py-4 ${buttonClasses} rounded-full font-bold uppercase tracking-widest text-sm transition-all hover:pr-12`}
                >
                    View Case Study
